// SieteYMedia.java
package IV_Arrays_y_Diseño_dos_capas.III_Usar_dos_capas_Logicas.Soluciones_Propias.sieteymediosolution.sieteymedia;

import IV_Arrays_y_Diseño_dos_capas.III_Usar_dos_capas_Logicas.Soluciones_Propias.sieteymediosolution.recursos.Baraja;
import IV_Arrays_y_Diseño_dos_capas.III_Usar_dos_capas_Logicas.Soluciones_Propias.sieteymediosolution.recursos.Carta;
...
public class SieteYMedia {
  ...
  // CONSTRUCTORS
  /**
   * Constructor sin parámetros que prepara partida. Crea la baraja, la reparte, y prepara las cartas de los jugadores,
   * Usuario y Banca
   */
  public SieteYMedia() {
    baraja = new Baraja();
  ...
  /**
   * Devuelve el valor de un grupo de cartas a elegir
   *
   * @param cartas El grupo de cartas a contar
