package IV_Arrays_y_Diseño_dos_capas.IV_Array_Multidimensionales.F_ejercicios_matriz_multidimensionales.sol_propias.Ejercicio_2_Reinas_Atacadas_reto_244;

/* Ejercicio U4_B4A_E10:
    en coderunner resolver reinas atacadas id 244

    En enunciado se añade en PDF previo al texto
    ...
    escaques en vertical, horizontal, o diagonal.
    ...
    Las posiciones de cada reina también se separarán por un único espacio. 

    Todas las posiciones serán válidas 
    (cada coordenada estará entre 1 y el tamaño del tablero) y se garantiza que no habrá dos 
    reinas en la misma posición.
...
public class Ejercicio_2_Reinas_Atacadas_reto_244 {
