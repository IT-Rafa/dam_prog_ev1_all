package IV_Arrays_y_Diseño_dos_capas.IV_Array_Multidimensionales.F_ejercicios_matriz_multidimensionales.sol_propias.Ejercicio_6_Sudokus_Correctos_reto_345;
...
public class Ejercicio_6_Sudokus_Correctos_reto_345 {
      ...
      for (int col = 0; col < SUDOKU_TAM; col += GRILLA_TAM) {
        ...
        for (int pos = 0; pos < SUDOKU_TAM - 1; pos++) {
          for (int pos2 = pos + 1; pos2 < SUDOKU_TAM; pos2++) {
            if (
              sudoku[fila + pos % GRILLA_TAM][col + pos / GRILLA_TAM] ==
              sudoku[fila + pos2 % GRILLA_TAM][col + pos2 / GRILLA_TAM]
            ) {
              return false;
            }
          }
